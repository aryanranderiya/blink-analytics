export default function Footer() {
  return (
    <footer className="sm:min-h-[25vh] h-fit flex justify-evenly flex-col z-[0]">
      ...
      <div className="flex-col px-3 pb-[5px] sm:text-[16px] text-[7px] sm:gap-2 gap-0 flex-wrap items-center justify-center 2K:text-[25px]">
        ...
        <div className="flex justify-between sm:text-[12px] text-[6px]">
        <div className="sm:text-[12px] text-[6px] 2K:text-[25px]">&copy; BLINK ANALYTICS, {new Date().getFullYear()} </div>
        <div className="text-nowrap sm:text-[12px] text-[6px] 2K:text-[25px]">
