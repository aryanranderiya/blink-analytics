export default function Footer() {
  return (
    <footer className="sm:min-h-[25vh] h-fit flex justify-evenly flex-col z-[0]">
      ...
      <div className="flex-col px-3 pb-[5px] sm:text-[20px] text-[8px] sm:gap-2 gap-0 flex-wrap items-center justify-center">
        ...
        <div>&copy; BLINK ANALYTICS, {new Date().getFullYear()} </div>
