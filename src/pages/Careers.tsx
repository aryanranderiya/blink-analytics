  ...
  return (
    <div className="min-h-screen bg-black z-[1] sticky flex flex-col justify-center snap-y snap-mandatory overflow-hidden">
      ...
      <div className="px-10 rounded-b-[50px] sm:pt-[60px] pt-[80px] flex flex-col items-center justify-center gap-5">
        <h1 className="font-bold sm:text-5xl text-4xl text-center bg-clip-text text-transparent bg-gradient-to-t from-pink-600 to-purple-500 2K:text-[4vw]">
          Shape the Future with us
        </h1>
        <div className="text-white sm:text-2xl text-md text-center sm:max-w-[50vw] leading-none sm:font-bold tracking-wide 2K:text-[2vw] 2K:leading-[50px]">
      ...
      <div className="content flex flex-col items-center justify-center w-full px-[100px] pt-[30px] z-[10] gap-5">
        <h1 className="text-xl text-white text-sans-serif font-cat 2K:text-[1.5vw]">
          Why work with us?
        </h1>
        <div className="boxes flex flex-wrap gap-5 items-center justify-center">
          {[
            ...
            <div
              key={index}
              className="box border-2 border-[#c77dff] flex items-center justify-center p-5 relative cursor-pointer overflow-hidden w-[250px] sm:h-[70px] h-[60px] group hover:bg-[#c77dff] transition-colors 2K:h-[100px] 2K:w-[400px]"
            >
              <h1 className="text-top absolute text-white sm:text-xl text-lg font-bold w-full text-center transition-all group-hover:opacity-0 group-hover:translate-y-[-100%] 2K:text-[1.5vw]">
                {text}
              </h1>
              <h1 className="text-bottom absolute sm:text-xl text-lg font-serif text-[#240046] w-full text-center opacity-0 transition-all group-hover:opacity-100 2K:text-[1.5vw]">
                {text}
              </h1>
            </div>
          ))}
      ...
      <div className="button flex flex-col items-center justify-center py-[50px] gap-5">
        <p className="text-white sm:text-2xl text-lg text-center sm:max-w-[50vw] p-4 2K:text-[1.5vw]">
